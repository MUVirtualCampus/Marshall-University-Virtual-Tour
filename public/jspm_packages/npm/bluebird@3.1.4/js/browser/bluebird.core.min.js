  ...
  !function(t) {
    ...
    return function r(t, e, n) {
      ...
      7: [function(t, e, n) {
        ...
        e.exports = function(e, n) {
          ...
          var x,
              ...
              D = null,
              V = !1,
              Q = !(0 == I.env("BLUEBIRD_DEBUG") || !I.env("BLUEBIRD_DEBUG") && "development" !== I.env("NODE_ENV")),
              q = !(0 == I.env("BLUEBIRD_WARNINGS") || !Q && !I.env("BLUEBIRD_WARNINGS")),
              G = !(0 == I.env("BLUEBIRD_LONG_STACK_TRACES") || !Q && !I.env("BLUEBIRD_LONG_STACK_TRACES")),
              M = 0 != I.env("BLUEBIRD_W_FORGOTTEN_RETURN") && (q || !!I.env("BLUEBIRD_W_FORGOTTEN_RETURN"));
      ...
      15: [function(t, e, n) {
        ...
        e.exports = function() {
          ...
          return r.prototype.toString = function() {
            ...
            if (0 === (65536 & i)) {
              ...
              if (i = r._bitField, 0 === (65536 & i))
                if (o === C)
                  ...
                  j.checkForgottenReturns(o, a, "", r, this), r._resolveCallback(o);
            }
            ...
            var e = this._bitField;
            if (!((117506048 & e) >>> 16))
              return this._setRejected(), this._fulfillmentHandler0 = t, this._isFinal() ? d.fatalError(t, f.isNode) : void((65535 & e) > 0 ? 0 !== (134217728 & e) ? this._settlePromises() : d.settlePromises(this) : this._ensurePossibleRejectionHandled());
      ...
      21: [function(t, e, n) {
          ...
          try {
            if ("function" == typeof t) {
              var e = w.names(t.prototype),
                  n = w.isES5 && e.length > 1,
                  r = e.length > 0 && !(1 === e.length && "constructor" === e[0]),
                  i = R.test(t + "") && w.names(t).length > 0;
              if (n || r || i)
                return !0;
            }
            return !1;
        ...
        var L = "undefined" != typeof process && "[object process]" === b(process).toLowerCase(),
            N = {
              isClass: f,
              isIdentifier: _,
              inheritedDataKeys: O,
